...
namespace Figures
{
    public class SpeedTank : DecoratorTanks
    {
        public SpeedTank(FiguresAbstract tank) : base(tank,tank.Speed,tank.Armor,tank.Power,tank.Live)
        {
            this.Speed = tank.Speed + 1;
        }
